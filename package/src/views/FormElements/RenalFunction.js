      ...
      >
        ...
        >
          <Box>
            ...
            >
              Please enter your Renal Functon
            </Typography>
          <Box
            sx={{
                fontWeight: "500",
          ...
          >
            <Typography>Current Renal Function: {currentRenalFunction}</Typography>
          <TextField
              type="number"
              value={newRenalFunction}
              onChange={(e) => setNewRenalFunction(e.target.value)}
              placeholder="Enter new renal function"
              size = "small"
            />
            <Button
          variant="contained"
          ...
          OnClick={handleUpdateRenalFunction}
          onClick={handleUpdateRenalFunction}
        >
          Update
        </Button>
